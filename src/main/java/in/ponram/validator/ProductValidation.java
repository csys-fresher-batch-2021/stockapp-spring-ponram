...
public class ProductValidation {
	...
	public static boolean isValidProduct(Product product) {
		...
		boolean quantity = NumberValidator.isValidNumber(product.getAvailableQuantity(), "Invalid quantity");
	...
	/**
	 * This method is used to validate id is an valid integer This method is used to
	 * validate quantity is an valid integer
	 * 
	 * @param value
	 * @return true or false
	 */
